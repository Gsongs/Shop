package com.bawei.zhuangaowu114.zfb.util;

import com.bawei.zhuangaowu114.zfb.SignUtils;
...
public class OrderInfoUtil2_0 {
	 ...
	 * 构造支付订单参数列表
	 */
	public static Map<String, String> buildOrderParamMap(String app_id, boolean rsa2, int money) {
		Map<String, String> keyValues = new HashMap<String, String>();
